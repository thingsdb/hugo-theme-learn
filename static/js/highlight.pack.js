/*
  Highlight.js 10.0.0-beta.0 (41b9f38e)
            ...
            contains: [
                ...
                },
                {
                    ...
                    begin: new RegExp(
                        ...
                        'deep|del_enum|del_type|enum|enum_info|enums_info|err|event_id|float|has_enum|has_type|if|int|is_array|' +
                        'is_ascii|is_bool|is_bytes|is_enum|is_err|is_float|is_inf|is_int|' +
